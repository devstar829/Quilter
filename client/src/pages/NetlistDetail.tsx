...
const NetlistDetail: React.FC = () => {
  ...
  node
    .append("circle")
    .attr("r", (d: any) => {
      if (d.nodeType === "component") return 20;
      if (d.nodeType === "net") return 12;
      return 8;
    })
    .attr("fill", (d: any) => {
      if (d.nodeType === "component") return "#4caf50";
      if (d.nodeType === "net") return "#2196f3";
      return "#ff9800";
    })
    .attr("stroke", "#333")
  ...
  node
    .on("mouseover", (event: any, d: any) => {
      link
        .attr("stroke", (l: any) =>
          l.source.id === d.id || l.target.id === d.id ? "#f44336" : "#aaa"
        )
